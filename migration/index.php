...
<html>
  ...
  <body>
        ...
        <div class="uk-container">
          <nav class="uk-navbar" uk-navbar>
            <div class="uk-navbar-left">
              <a target="_blank" href="https://opengamescommunity.com" class="uk-navbar-item uk-logo">BlizzCMS by OpenGamesCommunity<sup class="uk-text-success">+</a>
            </div>
            <div class="uk-navbar-right">
              <div class="uk-navbar-item">
                <a target="_blank" href="https://github.com/open-games-community" class="uk-icon-button github uk-margin-small-right"><i class="fab fa-github"></i></a>
                <a target="_blank" href="https://discord.gg/wkkUEVUCrs" class="uk-icon-button discord"><i class="fab fa-discord"></i></a>
              </div>
            </div>
          </nav>
        </div>
        ...
        <div class="uk-grid uk-grid-small" data-uk-grid>
          ...
          <div class="uk-width-1-2@s">
            ...
            <?php if (!extension_loaded('curl')): ?>
              <div class="uk-alert-danger" uk-alert>
                <p><i class="fas fa-times-circle"></i> The php curl extension is required, Please enable it on your php.ini file removing ; before text</p>
              </div>
            <?php endif; ?>
            <?php if (!extension_loaded('gd')): ?>
              <div class="uk-alert-danger" uk-alert>
                <p><i class="fas fa-times-circle"></i> The php gd extension is required, Please enable it on your php.ini file removing ; before text</p>
              </div>
            <?php endif; ?>
            <?php if (!extension_loaded('mbstring')): ?>
              <div class="uk-alert-danger" uk-alert>
                <p><i class="fas fa-times-circle"></i> The php mbstring extension is required, Please enable it on your php.ini file removing ; before text</p>
              </div>
            <?php endif; ?>
            <?php if (!extension_loaded('mysqli')): ?>
              <div class="uk-alert-danger" uk-alert>
                <p><i class="fas fa-times-circle"></i> The php mysqli extension is required, Please enable it on your php.ini file removing ; before text</p>
              </div>
            <?php endif; ?>
            <?php if (!extension_loaded('openssl')): ?>
              <div class="uk-alert-danger" uk-alert>
                <p><i class="fas fa-times-circle"></i> The php openssl extension is required, Please enable it on your php.ini file removing ; before text</p>
              </div>
            <?php endif; ?>
            <?php if (!extension_loaded('soap')): ?>
              <div class="uk-alert-danger" uk-alert>
                <p><i class="fas fa-times-circle"></i> The php soap extension is required, Please enable it on your php.ini file removing ; before text</p>
              </div>
            <?php endif; ?>
            <?php if (!extension_loaded('gmp')): ?>
              <div class="uk-alert-danger" uk-alert>
                <p><i class="fas fa-times-circle"></i> The php gmp extension is required, Please enable it on your php.ini file removing ; before text</p>
              </div>
            <?php endif; ?>
            <form id="form_install" action="" method="POST" accept-charset="utf-8" autocomplete="off">
              ...
              <div class="uk-margin-small uk-light">
                <div class="uk-grid uk-grid-small" data-uk-grid>
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <input name="hostname" class="uk-input" type="text" id="hostname" placeholder="127.0.0.1:3304" required>
                    </div>
                  </div>
                  <div class="uk-inline uk-width-1-2@s">
                    <label class="uk-form-label"><strong>Website</strong> Database Name:</label>
                    <div class="uk-form-controls">
                      <input name="database" class="uk-input" type="text" id="database" placeholder="Database name" required>
                    </div>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small uk-light">
                <div class="uk-grid uk-grid-small" data-uk-grid>
                  <div class="uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <input name="username" class="uk-input" type="text" id="username" placeholder="Username usually root" required>
                    </div>
                  </div>
                  <div class="uk-width-1-2@s">
              ...
              <div class="uk-margin-top uk-margin-small-bottom uk-light">
                <div class="uk-grid uk-grid-small" data-uk-grid>
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <input name="hostname2" class="uk-input" type="text" id="hostname2" placeholder="127.0.0.1:3304" required>
                    </div>
                  </div>
                  <div class="uk-inline uk-width-1-2@s">
                    <label class="uk-form-label"><strong>Auth</strong> Database Name:</label>
                    <div class="uk-form-controls">
                      <input name="database2" class="uk-input" type="text" id="database2" placeholder="Database name" required>
                    </div>
                  </div>
                </div>
              </div>
              <div class="uk-margin-small uk-light">
                <div class="uk-grid uk-grid-small" data-uk-grid>
                  <div class="uk-inline uk-width-1-2@s">
                    ...
                    <div class="uk-form-controls">
                      <input name="username2" class="uk-input" type="text" id="username2" placeholder="Username usually root" required>
                    </div>
                  </div>
                  <div class="uk-inline uk-width-1-2@s">
              ...
              <div class="uk-margin">
                <?php if ($core->checkExtension() && $core->PHPVersion()): ?>
                  <button class="uk-button uk-button-primary uk-width-1-1 uk-margin-small-bottom" type="submit" form="form_install"><i class="fas fa-cog fa-spin"></i> Install Website</button>
                <?php endif; ?>
              </div>
            </form>
          </div>
    ...
    <section class="uk-section uk-section-xsmall">
      <div class="uk-container">
        <h5 class="uk-h5 uk-text-center uk-margin-remove">Copyright <i class="far fa-copyright"></i> <?= date('Y'); ?> <span class="uk-text-bold">BlizzCMS</span>.By <a href="https://opengamescommunity.com">Alex</a>. All rights reserved</h5>
      </div>
    </section>
  </body>
</html>
